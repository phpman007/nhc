...
class orCheckController extends Controller
{
    ...
    public function index()
    {
        ...
        if(!empty($input['txtsection'])){
            $list->where('member_details.section','=',$input['txtsection']);
        }
        ...
        return view('/backend/check/orCheck',compact('listprovince','listgroupor','listsection','liststatus','listmember','countprovince'));
    }
