            ...
            @else
                <table class="table table-striped table-bordered">
                    ...
                    @foreach ($listmember as $key=>$valmember)
                        ...
                        <form name="frmchangedate[]" method="GET" action="{{url('backend/election/ORchangedate')}}">
                            {{ csrf_field() }}
                        ...
                        {{--  </form>
                        <form name="frmchangedate2[]" method="GET" action="{{url('backend/election/ORchangedate2')}}">
                            {{ csrf_field() }}
                        ...
                        <form name="frmchangedate3[]" method="GET" action="{{url('backend/election/ORchangedate3')}}">
                            {{ csrf_field() }}
