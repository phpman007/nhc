        ...
        <table border="1" bordercolor="black" cellspacing="0">
            <tr align="middle">
             ...
             @foreach ($listmember as $key=>$valmember)
                ...
                <td align="middle">{{ \Carbon\Carbon::parse($valmember->created_at)->addYears(543)->format('d/m/Y H:m:i') }}</td>
                <td align="middle">{{ \Carbon\Carbon::parse($valmember->updated_at)->addYears(543)->format('d/m/Y H:m:i') }}</td>
                <td align="middle">{{$valmember->last_step}}</td>

                @if($valmember->legalStatus == 1)
                    @php
