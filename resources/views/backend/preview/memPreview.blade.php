...
<div class="card border-info mb-3">
    <div class="card-header">
        <strong>ตรวจสอบหลักฐานผู้รับสิทธิ์ลงคะแนน ผู้แทนองค์กรปกครองส่วนท้องถิ่น</strong>
        <div align="right">
            @php
                $keynow=0;
                $id2=0;
            ...
            @if($id2!=0)
            <a href="/backend/memPreview/{{ $id2 }}"><button type="button" class="btn btn-primary"><i class="fa fa-chevron-left"></i> ก่อนหน้า</button></a>
            @endif

            @if($id3!=0)
            <a href="/backend/memPreview/{{ $id3 }}"><button type="button" class="btn btn-primary">ถัดไป <i class="fa fa-chevron-right"></i></button></a>
            @endif
            {{-- <i class="fa fa-print"></i> --}}
            <button class="btn btn-primary" type="button" onClick="window.print()"><i class="fa fa-print"></i> พิมพ์</button>
            <a href="{{ url('backend/check/memCheck') }}"><button id="back" name="back" type="button" class="btn btn-info"><i class="fa fa-times"></i> ปิด</button></a>
        </div>
    </div>
    <div class="card-body">
