...
<div class="card border-info mb-3">
    ...
    <strong>แสดงข้อมูล ผู้แทนองค์กรภาคเอกชน (NGOs)</strong>
        <div align="right">
            @php
                $keynow=0;
                $id2=0;
            ...
            @endphp
                ...
                <a href="{{ url('backend/view/ngoView') }}"><button id="back" name="back" type="button" class="btn btn-danger"><i class="fa fa-times"></i> ปิด</button>
                </a>
        </div>
    </div>
    <div class="card-body">
        @if(!empty($member))
            ...
            <div class="text-right">
                @if (!empty($member->confirmed_at))
                    วันที่ {{ $member->confirmed_at->format('d') }} เดือน {{ Helper::monthThai( @ $member->confirmed_at->addYears('543')->format('m')) }} พ.ศ.{{ $member->confirmed_at->addYears(543)->format('Y') }}
                @else
                    วันที่ ........ เดือน ................. ปี ............
                @endif
            </div>
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            ...
                            <li>2) เกิดวันที่<div class="box-input" style="width:100px;">
                                    @if(!empty($member->detail->dateOfBirth))
                                {{ @ Carbon\Carbon::parse($member->detail->dateOfBirth)->format('d') }}
                                @endif
                            </div>
                                &nbsp;เดือน<div class="box-input" style="width:300px;">
                                        @if(!empty($member->detail->dateOfBirth))
                                ...
                                <div class="box-input" style="width:100px;">@if(!empty($member->detail->dateOfBirth))
                                        @php
        ...
        @endif
	    <div align="right">
                <a href="{{ url('backend/view/ngoView') }}"><button id="back" name="back" type="button" class="btn btn-danger"><i class="fa fa-times"></i> ปิด</button></a>
        </div><br><br><br><br>
    </div>
</div>
@endsection
