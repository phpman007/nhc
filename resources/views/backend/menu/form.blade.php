        ...
        <div class="ibox-content">
            <form method="POST" action="{{ url('backend/user/store') }}">
                ...
                <div class="form-group  row"><label class="col-sm-2 col-form-label">จังหวัด</label>
                    <div class="col-sm-10">
                            {!! Form::select('provinceId', $province->pluck('province', 'provinceId'),null, ['class'=>'form-control', 'placeholder' => 'เลือกข้อมูลจังหวัด']) !!}
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
                ...
                <div class="form-group  row"><label class="col-sm-2 col-form-label">ตำแหน่ง / กำหนดสิทธิ์</label>
                      <div class="col-sm-10">
                           <ul>
                                 ...
                                 <li style="list-style:none;"><div class="form-check-inline i-checks"><label>{!! Form::radio('permission', $g->id, null) !!} <i></i> {{$g->name}} </label></div></li>
                                 @endforeach
                           </ul>
