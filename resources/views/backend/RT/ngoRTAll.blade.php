...
<nav aria-label="breadcrumb">
    <h4>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/backend/RT/ngoRT?txtsection={{$sectionid}}&txtprovince={{$provinceid}}&txtlevel={{$level}}">&nbsp;&nbsp;ผลการลงคะแนนแบบ Real Time ผู้แทนองค์กรภาคเอกชน</a></li>
            ...
            <div class="control-insitepage2f">
                <div class="container">
                    ...
                    @else
                        ...
                        <a href="/backend/RT/ngoRTAll/'.$group_id.'/'.$provinceid.'/'.$sectionid.'/'.$level"><button type="button" class="btn btn-primary">Refresh</button></a>
                        {{--  </div>  --}}
                        <br><br>
                        ...
                        <div class="content-table-list2f table-blue">
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            {{--  @if($One == $valpoint->sumPoints )
                                                <td><a href="/backend/RT/NGOconfirm}}"><button class="btn btn-primary" type="button">รับรองผลการลงคะแนน</button></a></td>
                                            @else <td></td> @endif  --}}

                                            @if($One == $valpoint->sumPoints )
                                            <form method="POST" name="frmOK[]" action="{{url('backend/RT/NGOconfirm')}}">
                                ...
                                <form id="frmRT" method="GET" action="{{url('backend/RT/ngoRTAll/'.$group_id.'/'.$provinceid.'/'.$sectionid.'/'.$level)}}">
