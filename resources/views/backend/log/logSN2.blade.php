    ...
    <nav aria-label="breadcrumb">
        <h4>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">การสมัครผู้ทรงคุณวุฒิ</li>
            </ol>
        </h4>
    </nav>
...
<div class="card border-info mb-3">
    ...
    <div class="card-body">
        ...
        <form method="GET" action="{{ url('backend/reportlog/logSN2/'.$id) }}">
            {{ csrf_field() }}
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="{{ url('backend/reportlog/logSN2/'.$id) }}"><button type="button"  class="btn btn-warning">ล้างคำค้น</button></a>
                    </div>
                </div>
            </div>
        </form>
                        ...
                        <table class="table table-striped table-bordered">
                            <tr align="middle">
                                ...
                                @foreach ($listlog as $key=>$vallog)
                                    ...
                                    <td align="middle"><a href="{{url('backend/reportlog/logSN3/'.$vallog->members.'/'.$id)}}">{{$vallog->members}}</a></td>
