...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <h4>
            ...
            <li class="breadcrumb-item"><a href="/backend/reportlog/logNGO2/{{$id}}">การสมัครผู้แทนองค์กรเอกชน</a></li>
                <li class="breadcrumb-item active" aria-current="page">รายละเอียดการสมัครแทนองค์กรเอกชน</li>
            </ol>
        </h4>
    </nav>
...
<div class="card border-info mb-3">
    ...
    <div class="card-header">
        <strong>สถิติผู้เข้าชมเว็บไซต์ สมัครผู้แทนองค์กรภาคเอกชน </strong>
    </div>
    <div class="card-body">
        @php $id=request()->id @endphp
        <form method="GET" action="{{ url('backend/reportlog/logNGO3/'.$email.'/'.$id) }}">
            {{ csrf_field() }}
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="{{ url('backend/reportlog/logNGO3/'.$email.'/'.$id) }}"><button type="button"  class="btn btn-warning">ล้างคำค้น</button></a>
                    </div>
                </div>
            </div>
        </form>
