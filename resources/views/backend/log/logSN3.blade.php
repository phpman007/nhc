    ...
    <nav aria-label="breadcrumb">
        <h4>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/backend/reportlog/logSN1">สถิติผู้เข้าชมเว็บไซต์การสมัครผู้ทรงคุณวุฒิ</a></li>
            <li class="breadcrumb-item"><a href="/backend/reportlog/logSN2/{{$id}}">การสมัครผู้ทรงคุณวุฒิ</a></li>
                <li class="breadcrumb-item active" aria-current="page">รายละเอียดการสมัครผู้ทรงคุณวุฒิ</li>
            </ol>
        </h4>
    </nav>
...
<div class="card border-info mb-3">
    ...
    <div class="card-body">
        ...
        <form method="GET" action="{{ url('backend/reportlog/logSN3/'.$email.'/'.$id) }}">
            {{ csrf_field() }}
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="{{ url('backend/reportlog/logSN3/'.$email.'/'.$id) }}"><button type="button"  class="btn btn-warning">ล้างคำค้น</button></a>
                    </div>
                </div>
            </div>
        </form>
        ...
        <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="d-flex justify-content-center" style="font-size: 13px !important;"><b>{{ $listlog->links() }}</b>
