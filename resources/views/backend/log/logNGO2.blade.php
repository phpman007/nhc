    ...
    <nav aria-label="breadcrumb">
        <h4>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">การสมัครผู้แทนองค์กรภาคเอกชน </li>
            </ol>
        </h4>
    </nav>
...
<div class="card border-info mb-3">
    ...
    <div class="card-header">
        <strong>สถิติผู้เข้าชมเว็บไซต์ การสมัครผู้แทนองค์กรภาคเอกชน</strong>
    </div>
    <div class="card-body">
        @php $id=request()->id @endphp
        <form method="GET" action="{{ url('backend/reportlog/logNGO2/'.$id) }}">
            {{ csrf_field() }}
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="{{ url('backend/reportlog/logNGO2/'.$id) }}"><button type="button"  class="btn btn-warning">ล้างคำค้น</button></a>
                    </div>
                </div>
            </div>
        </form>
                        ...
                        <table class="table table-striped table-bordered">
                            <tr align="middle">
                                ...
                                @foreach ($listlog as $key=>$vallog)
                                    ...
                                    <td align="middle"><a href="{{url('backend/reportlog/logNGO3/'.$vallog->members.'/'.$id)}}">{{$vallog->members}}</a></td>
