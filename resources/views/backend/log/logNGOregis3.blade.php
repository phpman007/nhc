    ...
    <nav aria-label="breadcrumb">
        <h4>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/backend/reportlog/logNGOregis2/{{$id}}">การขอขึ้นทะเบียนผู้แทนองค์กรภาคเอกชน</a></li>
                <li class="breadcrumb-item active" aria-current="page">รายละเอียดการขอขึ้นทะเบียนผู้แทนองค์กรภาคเอกชน  </li>
            </ol>
        </h4>
    </nav>
...
<div class="card border-info mb-3">
    ...
    <div class="card-body">
        ...
        <form method="GET" action="{{ url('backend/reportlog/logNGOregis3/'.$email.'/'.$id) }}">
            {{ csrf_field() }}
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="{{ url('backend/reportlog/logNGOregis3/'.$email.'/'.$id) }}"><button type="button"  class="btn btn-warning">ล้างคำค้น</button></a>
                    </div>
                </div>
            </div>
        </form>
