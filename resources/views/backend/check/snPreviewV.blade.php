...
<div class="card border-info mb-3">
    ...
    <strong>แสดงข้อมูล ผู้ทรงคุณวุฒิ รหัสผู้สมัคร {{ $member->id }}</strong>
        <div align="right">
            {{-- @php
                $keynow=0;
                $id2=0;
                    ...
                    <ul>
                        ...
                        <li>4)	สถานที่ที่สามารถติดต่อได้สะดวก <br>
                           ...
                           @elseif ($member->detail->addressType == 2)
                            ...
                            &nbsp;ตำบล/แขวง<div class="box-input" style="width:350px;">{{ @ $member->detail->district }}</div>
                            <br>
                            &nbsp;อำเภอ/เขต<div class="box-input" style="width:250px;">{{ @ $member->detail->amphoe }}</div>
                            &nbsp;จังหวัด<div class="box-input" style="width:250px;">{{ @ $member->detail->province }}</div>
