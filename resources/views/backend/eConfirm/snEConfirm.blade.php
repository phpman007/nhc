...
<nav aria-label="breadcrumb">
    <h4>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">ตรวจสอบรายชื่อผู้ทรงคุณวุฒิ ยืนยันใช้สิทธิลงคะแนน</li>
        </ol>
    </h4>
</nav>
...
<div class="mainpage">
    <div class="card border-info mb-3">
        ...
        <div class="card-header">
            <strong>ตรวจสอบรายชื่อผู้ทรงคุณวุฒิ ยืนยันใช้สิทธิลงคะแนน</strong>
        </div>
        <div class="card-body">
                <form id="frmsearchcheck" method="GET" action="{{url('backend/ElectionConfirm/snEConfirm')}}">
                {{ csrf_field() }}
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div class="form-group col-md-12 d-flex justify-content-center">
                                ...
                                <a href="{{url('backend/ElectionConfirm/snEConfirm')}}"><button type="button" class="btn btn-warning">ล้างคำค้น</button></a>
                            </div>
                        </div>
                    </div>
                </div>
