...
<html lang="en" dir="ltr">
      ...
      <body>
@if($groupid==1)
<p>วันที่ส่งเมล  {{ $member->created_at->format('d') }} {{ Helper::monthThai1($member->created_at->format('m')) }} {{ $member->created_at->addYears(543)->format('Y') }}</p>
