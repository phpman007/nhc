		...
		<div class="navication2f">
			<div class="container">
				<ol class="breadcrumb">
					...
					<li class="active">ผู้ทรงคุณวุฒิ สมัครเป็นกรรมการสุขภาพแห่งชาติ ขั้นตอนที่ 4</li>
				</ol>
			</div>
		...
		<div class="control-insitepage2f">
			<div class="container">
				...
				<div class="content-form2f">
					<h4>ผู้ทรงคุณวุฒิ สมัครเป็นกรรมการสุขภาพแห่งชาติ ขั้นตอนที่ 4</h4>
					...
					<div class="set-form2f">
						...
						<div class="box-input2f">
							<div class="row">
								...
								<div class="col-md-6 col-sm-8">
									<div class="input2f">
										<input type="text" name="" readonly="" value="{{ Auth::user()->nameTitle }}" class="form-control" placeholder="นาย/นาง/นางสาว" maxlength="30">
									</div>
								</div>
							</div><!--end row-->
						</div><!--end box-input2f-->
						...
						<div class="box-input2f">
							<div class="row">
								...
								<div class="col-md-6 col-sm-8">
									<div class="input2f">
										{!! Form::text('tel', Auth::user()->detail->tel , ['id'=>'tel','class'=>'form-control', 'placeholder'=> 'เบอร์โทรศํพท์ที่ 1']) !!}
										@if($errors->has('tel'))
				...
				<div class="box-input2f">
					<div class="row">
						...
						<div class="col-md-6 col-sm-8">
							<div class="input2f">
								{!! Form::text('mobile', Auth::user()->detail->mobile, ['id'=>'mobile', 'class'=>"form-control", 'placeholder'=>"เบอร์โทรศํพท์ที่ 2"]) !!}
				...
				<div class="box-input2f">
					<div class="row">
						...
						<div class="col-md-2 col-sm-2 col-xs-11">
							<div class="input2f">
								{!! Form::text('faculty2', Auth::user()->detail->faculty2, [ 'class'=>"form-control faculty2", 'placeholder'=>"สาขา"]) !!}
							</div>
						</div>
						<div class="col-md-3 col-sm-5 col-xs-12">
							<div class="input2f">
								{!! Form::text('institution2', Auth::user()->detail->institution2, [ 'class'=>"form-control institution2", 'placeholder'=>"สถาบัน"]) !!}
						...
						<div class="col-md-2 col-sm-2 col-xs-12">
							<div class="input2f">
								{!! Form::number('yearend2', Auth::user()->detail->yearend2, [ 'class'=>"form-control yearend2", 'placeholder'=>"ปีที่จบ"]) !!}
				...
				<div class="box-input2f">
					<div class="row">
						...
						<div class="col-md-2 col-sm-2 col-xs-12">
							<div class="input2f">
								{!! Form::text('faculty3', Auth::user()->detail->faculty3, [ 'class'=>"form-control faculty3", 'placeholder'=>"สาขา"]) !!}
							</div>
						</div>
						<div class="col-md-3 col-sm-5 col-xs-12">
							<div class="input2f">
								{!! Form::text('institution3', Auth::user()->detail->institution3, [ 'class'=>"form-control institution3", 'placeholder'=>"สถาบัน"]) !!}
						...
						<div class="col-md-2 col-sm-2 col-xs-12">
							<div class="input2f">
								{!! Form::number('yearend3', Auth::user()->detail->yearend3, [ 'class'=>"form-control yearend3", 'placeholder'=>"ปีที่จบ"]) !!}
				...
				<div class="box-input2f">
					<div class="row">
						...
						<div class="col-md-2 col-sm-2 col-xs-11">
							<div class="input2f">
								{!! Form::text('faculty4', Auth::user()->detail->faculty4, [ 'class'=>"form-control faculty4", 'placeholder'=>"สาขา"]) !!}
							</div>
						</div>
						<div class="col-md-3 col-sm-5 col-xs-12">
							<div class="input2f">
								{!! Form::text('institution4', Auth::user()->detail->institution4, [ 'class'=>"form-control institution4", 'placeholder'=>"สถาบัน"]) !!}
						...
						<div class="col-md-2 col-sm-2 col-xs-12">
							<div class="input2f">
								{!! Form::number('yearend4', Auth::user()->detail->yearend4, [ 'class'=>"form-control yearend4", 'placeholder'=>"ปีที่จบ"]) !!}
				...
				<div class="box-input2f">
					<div class="row">
						...
						<div class="col-md-6 col-sm-8">
							<div class="input2f">
								{!! Form::textarea('nowWork',  Auth::user()->detail->nowWork, ['rows'=>"4" ,'cols'=>"40" ,'class'=>"form-control" ,'placeholder'=>"ปัจจุบันปฏิบัติหน้าที่", 'onkeyup' => 'countChar2(this);']) !!}
								ท่านพิมพ์ได้อีก <span id="charNum-1">255</span> ตัวอักษร
				...
				<div class="box-input2f">
					<div class="row">
						...
						<div class="col-md-6 col-sm-8">
							<div class="input2f">
								{!! Form::textarea('nowWorkPlace',  Auth::user()->detail->nowWorkPlace, ['rows'=>"4" ,'cols'=>"40" ,'class'=>"form-control" ,'placeholder'=>"ชื่อองค์กร", 'onkeyup' => 'countChar3(this);']) !!}
				...
				<div class="box-input2f">
					<div class="row">
						...
						<div class="col-md-6 col-sm-8">
							<div class="input2f">
								{!! Form::textarea('nowRole',  Auth::user()->detail->nowRole, ['rows'=>"4" ,'cols'=>"40" ,'class'=>"form-control" ,'placeholder'=>"งานในความรับผิดชอบ", 'onkeyup' => 'countChar4(this);']) !!}
								ท่านพิมพ์ได้อีก <span id="charNum-3">800</span> ตัวอักษร
				...
				<div class="box-input2f">
					<div class="text-input2f"><span>3)</span>ประสบการณ์สำคัญหรือประสบการณ์ที่ภาคภูมิใจที่สัมพันธ์กับประเภทกลุ่มผู้ทรงคุณวุฒิที่เลือกสมัคร<br>(ท่านสามารถกรอกตัวอักษรได้ 1024 ตัวอักษร)</div>
				</div><!--end box-input2f-->
				<div class="box-input2f">
					<div class="row">
						<div class="col-md-12">
							<div class="input2f paddingleft20">
								{!! Form::textarea('importantMemo',  Auth::user()->detail->importantMemo, ['rows'=>"4" ,'cols'=>"40" ,'class'=>"form-control"
								,"onkeyup"=>"countChar(this)"
								,'placeholder'=>"ประสบการณ์สำคัญหรือประสบการณ์ที่ภาคภูมิใจที่สัมพันธ์กับประเภทกลุ่มผู้ทรงคุณวุฒิที่เลือกสมัคร (ท่านสามารถกรอกตัวอักษรได้ 1024 ตัวอักษร)"]) !!}
			...
			<div class="btn-center2f">
			     <a href="{{ url('/form-professional/3') }}" class="btn btn-border">ย้อนกลับ</a>
				<a href="{{ url('/cancel-form') }}/1/4" onclick="if(!confirm('ระบบจะไม่บันทึกข้อมูลและกลับไปยังหน้าแรก')) return false" class="btn btn-border confirmed-alert">ยกเลิก</a>
...
function countChar4(val) {
	...
	if (len >= 800) {
		...
		$('#charNum-3').text(800 - len);
	}
}
function countCharSet(val, number, selector) {
	console.log(11);
	var len = val.value.length;
	if (len >= number) {
		val.value = val.value.substring(0, number);
		$('#'+ selector).text(0);
	} else {
		$('#'+ selector).text(number - len);
	}
}
...
countChar2($('[name="nowWork"]')[0]);
countChar3($('[name="nowWorkPlace"]')[0]);
countChar4($('[name="nowRole"]')[0]);
</script>
...
jQuery(document).ready(function($) {
	...
	// $('[name="addressType"]').bind('change', function() {
	//     console.log($(this).val())
	//     if($(this).val() == 1) {
	// 	    $('[name="workPlaceName"]').parents('.box-input2f').fadeOut();
	//     } else {
	// 	    $('[name="workPlaceName"]').parents('.box-input2f').fadeIn();
	//     }
	// }).delay('500').trigger('change');
	// $('[name="addressType"]').trigger('change')
	for (var i = 1; i <= 5; i++) {
		var num = i;
