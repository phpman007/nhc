        ...
        <div class="navication2f">
            <div class="container">
              <ol class="breadcrumb">
                  ...
                  <li class="active">ยกเลิกaccount</li>
              </ol>
            </div>
              ...
              <div class="content-form2f loginpage">
                  ...
                  <div class="btn-center2f  t-left2f">
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          <button type="submit" name="button" class="btn btn-green">ยืนยัน</button>
                          <a href="{{ url('/') }}" class="btn btn-green">ยกเลิก</a>
                        </div>
                      </div>
