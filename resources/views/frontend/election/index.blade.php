...
<div class="btn-next-step">
    <button onclick="$('#modal-vote').modal('show')" type="button" class="btn btn-green" name="button">ดำเนินการขั้นตอนถัดไป</button>
  </div>
<div id="wrapper2f">
	   ...
	   <div class="modal-body">
		  <div class="content-popup2f">
			...
			<div class="text-sucess2f">
			  ท่านได้ลงคะแนน<br>คัดเลือกคณะกรรมการสุขภาพแห่งชาติ<br>เรียบร้อยแล้ว
			</div>
		  </div><!--end content-popup2f-->
	   </div><!--end modal-body-->
	 </div><!--end modal-content-->
		 ...
		 <div class="modal-content">
		   ...
		   <div class="modal-body">
			  <div class="content-popup2f">
				...
				<div class="btn-center-nonefix">
					<a id="step2ChangeNumber" type="button" name="button" class="btn btn btn-purple">ยกเลิก</a>
					<a id="step2Confirm" type="button" name="button" class="btn btn-green">ยืนยันการลงคะแนน</button>
				</div>
			  </div><!--end content-popup2f-->
		   </div><!--end modal-body-->
		 </div><!--end modal-content-->
	...
	function modalAddVoteStep2(number_score, candidateNumber, pic, fullName, id)
	{
		return '<tr data-id="'+ id +'" data-candidate="' + candidateNumber +'" data-number="'+ number_score +'" data-name="'+ fullName +'" data-img="'+ pic +'">'+
				  ...
				  '<td width="50%">'+
				    ...
				    '</div>'+
				  '</td>'+
				  '<td width="20%" class="t-center2f">'+
                                   '<div class="box-td-manage2f">'+
                                       '<button type="button" name="button" class="btn btn-delete-purple btn-delete-vote">ลบ</button>'+
                                   '</div>'+
                                 '</td>'+
				'</tr>';
	}
